...
if( $_POST )
{
  ...
  $synonyms = isset( $_POST['synonyms'] ) ? $_POST['synonyms'] : '';
  ...
  add( $id, $family, $subfamily, $tribe, $genus, $species, $order1, $synonyms, $locality_data, $deremination_label);
...
<html class="no-js" lang="en">
  <head>
    ...
    <title>New Data | Zamorano University</title>
    <link rel="stylesheet" href="./css/style.css" />
    <script src="./js/vendor/modernizr.js"></script>
  </head>
  <body>
    
    <?php require_once('header_newdata.php'); ?>
              ...
              <form method="post">
                <div class="row">
                  <div class="large-12 columns">
                    <label>ID
                      <input autofocus type="text" name="id" placeholder="" pattern="[0-9]{2}\.[0-9]{3}EAPZ" onchange="this.value=this.value.toUpperCase()"/>
                    </label>
                  </div>
                </div>
                <div class="row">
                  <div class="large-12 columns">
                    <label>Family
                      <input type="text" name="family" placeholder="" pattern="[a-zA-Z]+" />
                    </label>
                  </div>
                </div>
                <div class="row">
                  <div class="large-12 columns">
                    <label>Subfamily
                      <input type="text" name="subfamily" placeholder="" pattern="[a-zA-Z]+"/>
                    </label>
                  </div>
                </div>
                <div class="row">
                  <div class="large-12 columns">
                    <label>Tribe
                      <input type="text" name="tribe" placeholder="" pattern="[a-zA-Z]+"/>
                    </label>
                  </div>
                </div>
                <div class="row">
                  <div class="large-12 columns">
                    <label>Genus
                      <input type="text" name="genus" placeholder="" pattern="[a-zA-Z]+"/>
                    </label>
                  </div>
                </div>
                <div class="row">
                  <div class="large-12 columns">
                    <label>Species
                      <input type="text" name="species" placeholder="" pattern="[a-zA-Z]+"/>
                    </label>
                  </div>
                </div>
                ...
                <div class="row">
                  <div class="large-12 columns">
                    <label>Locality Data
                      <input type="text" name="locality_data" pattern="[a-zA-Z ]+" placeholder="" />
                    </label>
                  </div>
                </div>
                ...
                <div class="row">
                  <div class="large-12 columns">
                    <label>Determination Label
                      <input type="text" name="deremination_label" pattern="[a-zA-Z ]+" placeholder="" />
                    </label>
                  </div>
                </div>
                <div class="row">
  ...
  <!--   <div class="row">
                  <div class="large-12 columns">
                    ...
                    <label>Provincia o Departamento
                      <input type="text" name="Departamento" placeholder="" pattern="[a-zA-Z ]+"/>
                    </label>
                    <label>Lugar (Parque, Reserva Biologica, etc)
                      <input type="text" name="Lugar" placeholder="" pattern="[a-zA-Z ]+"/>
                    </label>  
                    <label>Elevación
